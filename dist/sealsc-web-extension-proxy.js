(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.sealscWebExtensionProxy = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
},{"regenerator-runtime":20}],6:[function(require,module,exports){
"use strict";
...
},{"./predefinedStatus":7}],7:[function(require,module,exports){
"use strict";
...
},{"../types/status":16}],8:[function(require,module,exports){
"use strict";
...
},{"./consts/consts":6,"./types/types":17,"./utils":18}],9:[function(require,module,exports){
"use strict";
...
},{"../../consts/predefinedStatus":7,"../result":15}],11:[function(require,module,exports){
"use strict";
...
},{"../../consts/predefinedStatus":7,"../result":15}],12:[function(require,module,exports){
"use strict";
...
},{"../../consts/predefinedStatus":7,"../result":15}],13:[function(require,module,exports){
"use strict";
...
},{"../../consts/predefinedStatus":7,"../result":15}],14:[function(require,module,exports){
"use strict";
...
},{"../../consts/predefinedStatus":7,"../result":15,"./extensionActions":10,"./extensionChecker":11,"./extensionConnector":12,"./extensionContractCaller":13}],15:[function(require,module,exports){
"use strict";
...
},{"./contractWrapper":9,"./extension/extensionWrapper":14,"./result":15,"./status":16}],18:[function(require,module,exports){
"use strict";
...
},{"./consts/predefinedStatus":7,"./types/status":16,"decimal.js":19}],19:[function(require,module,exports){
...
},{"@babel/runtime/helpers/asyncToGenerator":1,"@babel/runtime/helpers/interopRequireDefault":4,"@babel/runtime/regenerator":5,"@sealsc/web-extension-protocol":8}],22:[function(require,module,exports){
"use strict";
...
function () {
  function ExtensionProxy() {
    (0, _classCallCheck2["default"])(this, ExtensionProxy);
    this.status = _webExtensionProtocol.consts.predefinedStatus.NOT_LOADED(null);
    this.extension = null;
  }

  (0, _createClass2["default"])(ExtensionProxy, [{
    key: "link",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return this.extension.connector.link(param);

              case 3:
                return _context.abrupt("return", _context.sent);

              case 6:
                return _context.abrupt("return", new _webExtensionProtocol.types.Result(null, _webExtensionProtocol.consts.predefinedStatus.NOT_LOADED(null)));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", this.extension.connector.unlink());

              case 4:
                return _context2.abrupt("return", new _webExtensionProtocol.types.Result(null, _webExtensionProtocol.consts.predefinedStatus.NOT_LOADED(null)));
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                _context3.next = 4;
                return this.extension.checker.isLogin();
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return this.extension.checker.isMainnet();
...
},{"./actions":21,"@babel/runtime/helpers/asyncToGenerator":1,"@babel/runtime/helpers/classCallCheck":2,"@babel/runtime/helpers/createClass":3,"@babel/runtime/helpers/interopRequireDefault":4,"@babel/runtime/regenerator":5,"@sealsc/web-extension-protocol":8}]},{},[22])(22)
});
